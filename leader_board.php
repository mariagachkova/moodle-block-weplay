...
FROM {block_wp_level} lvl LEFT OUTER JOIN {block_wp_avatar} avt ON avt.userid = lvl.userid AND avt.courseid = lvl.courseid
WHERE lvl.courseid = $courseid ORDER BY lvl.points DESC LIMIT 20
sql;
